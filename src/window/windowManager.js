    ...
    const createFeatureWindow = (name) => {
        ...
        switch (name) {
            ...
            case 'ask': {
                ...
                // Initialize click-through state as enabled
                ask.isClickThrough = true;
                // Enable click-through mode on startup
                ask.setIgnoreMouseEvents(true, { forward: true });
...
function createWindows() {
    ...
    const header = new BrowserWindow({
        ...
        resizable: false,
        focusable: false,  // ADD THIS - Window cannot receive focus
